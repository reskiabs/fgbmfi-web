    ...
    <div className="space-y-2.5 lg:space-y-5">
      {aboutUsItems.map((item, index) => {
        ...
        return (
          ...
          >
            <button
              className="flex items-center justify-between w-full px-[15px] py-[17px] text-sm md:text-[18px] font-medium text-left text-gray-900 lg:text-xl lg:px-6 lg:py-7"
            ...
            {isOpen && (
              <div className="px-[15px] border-gray-200 pb-[15px] lg:px-6 lg:pb-7">
                <div
                  className="text-sm font-normal text-gray-500 text-justify md:text-[14px] lg:text-xl"
