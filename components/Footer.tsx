...
const Footer = () => {
  return (
    <div className="w-full">
      <div className="bg-gradient-to-b from-primary to-primary-dark w-full h-[124px] flex flex-col justify-center items-center md:flex-row md:justify-between md:px-[40px] lg:px-[255px] md:h-[162px] lg:h-[192px]">
      ...
      <div className="bg-gradient-to-b  gap-2 from-secondary to-teritary w-full h-[32px] flex flex-col justify-center items-center md:items-start md:px-[40px] lg:px-[255px] md:h-[42px] lg:h-[60px]">
